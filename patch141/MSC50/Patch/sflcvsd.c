/*  ----------------------------------------------------------------<Prolog>-
    ...
    Revised:    96/12/31  Pieter Hintjens <ph@imatix.com>
...
long
conv_str_date (char *string, word flags, int format, int order)
{
    static
        char *month_name [] =
          {
    ...
    char
        ...
        month_letters [4],              /*  3 characters of month            */	/* Modified for MSC 5.0 by Jau-Bing Lin on 2023-11-23 */
    ...
    order_index = (order - 1) * 5;      /*  Each row has 5 items             */
